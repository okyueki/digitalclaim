    ...
    <div class="col-md-12 col-xl-12">
        <div class=" main-content-body-invoice">
            <div class="card card-invoice">
                <div class="card-body">
                    <form name="frm_aturadmin" method="get" action="{{ route('listvedika') }}" enctype="multipart/form-data">
                        @csrf
                                            ...
                                            <div class="btn-list d-flex align-items-center flex-wrap">
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                        ...
                                                        <li><a class="dropdown-item" href="{{ route('listvedika.validasiverifikator',encrypt($result->no_rawat)) }}">Validasi Verifikator</a></li>
